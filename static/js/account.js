...
const statusText = document.querySelector('#account main section:nth-of-type(2) article:nth-of-type(2) p')
...
const changeStatusText = () => {
    if(statusText == null) {
        ...
        addStatusButton.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
